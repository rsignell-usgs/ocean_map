...
var Albers = function() {
  ...
  var phi1 = radians(15.0);
  var phi2 = radians(48.0);
  var n = .5 * (phi1 + phi2);
	var C = Math.cos(phi1) * Math.cos(phi1) + 2 * n * Math.sin(phi1);
	var phi0 = radians(33.0);
	var lambda0 = radians(-80.0);
...
1000, 0, canvas.height, -100.0, 15.0);
  ...
  var navDiv = document.getElementById("city-display");
	...
	var mask = new MapMask(document.getElementById('mask'), 800, 600);
